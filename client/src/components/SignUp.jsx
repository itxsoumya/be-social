      ...
      <div className="flex sm:bg-slate-100 sm:p-12 p-2 sm:shadoww-xl sm:rounded-xl flex-col items-center sm:gap-8 gap-4">
        ...
        <form className="flex flex-col gap-1">
          ...
          <div className="flex bg-redd-200 m-6 p-6 gap-2">
            <div className="flex-grow bg-slatee-500 text-lg flex justify-center items-center text-sky-600 underline">
              Login
            </div>
            <div className="flex-grow bg-slatee-500 text-lg flex justify-center items-center">
              or
            </div>
            <div className="flex-grow bg-slatee-500 flex justify-center items-center">
              <button className="bg-zinc-800 p-2 px-4 rounded-3xl text-white text-lg">Create</button>
            </div>
